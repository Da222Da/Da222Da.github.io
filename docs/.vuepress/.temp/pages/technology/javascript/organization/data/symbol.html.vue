<template><h1 id="symbol-唯一值" tabindex="-1"><a class="header-anchor" href="#symbol-唯一值" aria-hidden="true">#</a> Symbol 唯一值</h1>
<nav class="table-of-contents"><ul><li><RouterLink to="#es6-引入-symbol-数据类型的原因">ES6 引入 Symbol 数据类型的原因？</RouterLink></li><li><RouterLink to="#symbol-给-javascript-带来的改变">Symbol 给 JavaScript 带来的改变？</RouterLink></li><li><RouterLink to="#深入了解-symbol-属性">深入了解 Symbol 属性</RouterLink><ul><li><RouterLink to="#symbol-prototype-description-symbol-函数接受一个字符串参数的意义">Symbol.prototype.description || Symbol() 函数接受一个字符串参数的意义？</RouterLink></li><li><RouterLink to="#symbol-hasinstance-指向-instanceof-运算符的执行函数">Symbol.hasInstance &amp;&amp; 指向 instanceof 运算符的执行函数</RouterLink></li></ul></li></ul></nav>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="symbol-给-javascript-带来的改变" tabindex="-1"><a class="header-anchor" href="#symbol-给-javascript-带来的改变" aria-hidden="true">#</a> Symbol 给 JavaScript 带来的改变？</h2>
<ul>
<li>使用 symbol 值来做对象的属性名。换言之，对象的属性名现在可以有两种类型<code>字符串 &amp;&amp; Symbol类型</code></li>
</ul>
...
<p>但是，可以通过 <code>Object.getOwnPropertySymbols() &amp;&amp; Reflect.ownKeys()</code>获取。</p>
</div>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="symbol-hasinstance-指向-instanceof-运算符的执行函数" tabindex="-1"><a class="header-anchor" href="#symbol-hasinstance-指向-instanceof-运算符的执行函数" aria-hidden="true">#</a> Symbol.hasInstance &amp;&amp; 指向 instanceof 运算符的执行函数</h3>
<p><code>Object[Symbol.hasInstance]</code> 指向一个方法（该方法是 instanceof 运算符执行时，所调用的 JavaScript 语言内部方法。）</p>
