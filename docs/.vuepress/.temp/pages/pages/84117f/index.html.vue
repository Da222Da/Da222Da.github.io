<template><h1 id="npm-package-commander-调研报告" tabindex="-1"><a class="header-anchor" href="#npm-package-commander-调研报告" aria-hidden="true">#</a> NPM Package Commander 调研报告</h1>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p><code>1.Target：调研目标</code> <br></p>
<ul>
<li>熟悉 Commander 的使用</li>
</ul>
<p><code>2.Title：调研目录</code></p>
<nav class="table-of-contents"><ul><li><RouterLink to="#一、快速上手">一、快速上手</RouterLink><ul><li><RouterLink to="#_1-commander-the-complete-solution-for-node-js-command-line-interfaces">1. Commander: The complete solution for node.js command-line interfaces.</RouterLink></li><li><RouterLink to="#_3-program-name-修改帮助信息中程序名称">3. program.name()修改帮助信息中程序名称</RouterLink></li><li><RouterLink to="#_4-program-usage-自定义帮助信息里面的使用描述信息">4. program.usage()自定义帮助信息里面的使用描述信息</RouterLink></li><li><RouterLink to="#_5-自定义-version-选项的两种方式">5. 自定义 version 选项的两种方式</RouterLink></li><li><RouterLink to="#_6-program-opts-能够拿到-program-parse-arguments-解析后的-options-参数">6. program.opts() 能够拿到 program.parse(arguments)解析后的 options 参数</RouterLink></li><li><RouterLink to="#_7-program-outputhelp-使用代码的形式展示帮助信息-不退出程序。">7. program.outputHelp() 使用代码的形式展示帮助信息，不退出程序。</RouterLink></li><li><RouterLink to="#_8-program-showhelpaftererror-在出错后展示帮助信息">8. program.showHelpAfterError() 在出错后展示帮助信息</RouterLink></li><li><RouterLink to="#_9-如何利用-program-args-的特性-监听未知命令">9. 如何利用 program.args 的特性，监听未知命令？</RouterLink></li><li><RouterLink to="#_10-命令处理函数-action-的参数含义是什么-以及它该怎么用">10. 命令处理函数 action()的参数含义是什么？以及它该怎么用？</RouterLink></li></ul></li><li><RouterLink to="#附录-a">附录 A:</RouterLink><ul><li><RouterLink to="#commander-官方文档">commander 官方文档</RouterLink></li></ul></li></ul></nav>
</div>
...
<ul>
<li><code>program.name()</code>，程序名称，即主命令名称。默认值是 index。</li>
<li>参数用例，<code>例如，program.name(Object.keys(pkg.bin)[0])</code></li>
</ul>
...
<ul>
<li>参数用例，<code>例如，program.usage('[option] [command]')</code></li>
</ul>
...
<ul>
<li>1.方式 1：version api<code>例如，program.version(pkg.version)</code></li>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h3 id="_6-program-opts-能够拿到-program-parse-arguments-解析后的-options-参数" tabindex="-1"><a class="header-anchor" href="#_6-program-opts-能够拿到-program-parse-arguments-解析后的-options-参数" aria-hidden="true">#</a> 6. program.opts() 能够拿到 program.parse(arguments)解析后的 options 参数</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h3 id="_7-program-outputhelp-使用代码的形式展示帮助信息-不退出程序。" tabindex="-1"><a class="header-anchor" href="#_7-program-outputhelp-使用代码的形式展示帮助信息-不退出程序。" aria-hidden="true">#</a> 7. program.outputHelp() 使用代码的形式展示帮助信息，不退出程序。</h3>
...
<li>
<ol>
<li><code>program.showHelpAfterError()</code> 展示完整的帮助信息</li>
</ol>
</li>
<li>
<ol start="2">
<li><code>program.showHelpAfterError('(add --help for additional information)')</code> 自定义帮助信息</li>
</ol>
</li>
</ul>
</li>
...
program<span class="token punctuation">.</span><span class="token function">parse</span><span class="token punctuation">(</span>process<span class="token punctuation">.</span>argv<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h3 id="_10-命令处理函数-action-的参数含义是什么-以及它该怎么用" tabindex="-1"><a class="header-anchor" href="#_10-命令处理函数-action-的参数含义是什么-以及它该怎么用" aria-hidden="true">#</a> 10. 命令处理函数 action()的参数含义是什么？以及它该怎么用？</h3>
<ul>
<li>
...
<p>2.测试用例</p>
<ul>
<li>2-1：在全局命令上使用处理函数<code>program.action()</code></li>
</ul>
...
<li>2-2：在普通命令上使用处理函数<code>program.command().action()</code></li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token hashbang comment">#! /usr/bin/env node</span>
...
<h3 id="commander-官方文档" tabindex="-1"><a class="header-anchor" href="#commander-官方文档" aria-hidden="true">#</a> <a href="https://github.com/tj/commander.js/blob/HEAD/Readme_zh-CN.md" target="_blank" rel="noopener noreferrer">commander 官方文档<OutboundLink/></a></h3>
</template>
