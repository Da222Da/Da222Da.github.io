<template><div><h1 id="webpack-5-调研报告" tabindex="-1"><a class="header-anchor" href="#webpack-5-调研报告" aria-hidden="true">#</a> Webpack@5 调研报告</h1>
<div class="custom-container tip"><p class="custom-container-title">webpack: 针对于 JavaScript 应用程序的"打包工具"和"构建工具"</p>
<nav class="table-of-contents"><ul><li><router-link to="#第一分部-使用整体思维模式认识-webpack">第一分部：使用整体思维模式认识 Webpack</router-link></li><li><router-link to="#第二分部-使用专精思维模式练习-webpack">第二分部：使用专精思维模式练习 Webpack</router-link><ul><li><router-link to="#_1-webpack-是如何解决-multiple-chunks-导致输出文件名冲突的问题">1. webpack 是如何解决&quot;multiple chunks&quot;导致输出文件名冲突的问题？</router-link></li><li><router-link to="#_2-以图片资源为例-看看-webpack-5-是如何处理资源模块的">2. 以图片资源为例，看看 webpack@5 是如何处理资源模块的？</router-link></li><li><router-link to="#_3-webpack-文件监听原理-watch-watchoptions">3. webpack 文件监听原理 watch &amp;&amp; watchOptions</router-link></li><li><router-link to="#_4-webpack-提供的文件指纹策略-hash-chunkhash-contenthash">4. webpack 提供的文件指纹策略 Hash &amp;&amp; ChunkHash &amp;&amp; Contenthash</router-link></li><li><router-link to="#_5-热更新替换解决了哪些问题-其原理又是怎么样的">5.热更新替换解决了哪些问题？其原理又是怎么样的？</router-link></li><li><router-link to="#_6-注意-在使用-postcss、babel-的时候-记得添加-browserslist-属性。">6.注意！在使用 PostCSS、Babel 的时候，记得添加 browserslist 属性。</router-link></li></ul></li></ul></nav>
<p><a href="https://webpack.docschina.org/concepts/" target="_blank" rel="noopener noreferrer">webpack 中文文档<ExternalLinkIcon/></a></p>
</div>
...
<p>webpack 一款针对于 JavaScript 应用程序的静态文件打包工具。简而言之，webpack 能将不同类型的文件模块<code v-pre>例如，.js | .css | .png等的</code>，按照我们自定义的 webpack 规则<code v-pre>webpack.config.js</code>，输出一个或多个 bundle 包文件并重组、拼接形成一个更符合我们需求的 JavaScript 应用程序。</p>
...
<ul>
<li><code v-pre>1.entry 指定打包入口 &amp;&amp; 默认值：./src/index.js</code></li>
<li><code v-pre>2.output 指定打包出口 &amp;&amp; 默认值：./dist/main.js</code> 用来告诉 webpack 将编译后的文件输出到磁盘中的什么位置。</li>
<li><code v-pre>3.mode设置内置模式 &amp;&amp; 默认值: production 生产模式</code>用于指定 webpack 运行环境。</li>
<li><code v-pre>4.Loader文件类型扩展</code> webpack 开箱即用只支持.js 和.json 两种文件类型，若想支持其他类型的文件，则需要使用不同的 Loader，将源文件转化成 webpack 有效模块。</li>
<li><code v-pre>5.Plugins功能扩展</code></li>
</ul>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="第二分部-使用专精思维模式练习-webpack" tabindex="-1"><a class="header-anchor" href="#第二分部-使用专精思维模式练习-webpack" aria-hidden="true">#</a> 第二分部：使用专精思维模式练习 Webpack</h2>
...
<p>基于上述问题，webpack 引入了 watch 的概念，通过一个轮询机制<code v-pre>watchOptions.poll</code>不断地收集发生变化的文件，并将其缓存起来，然后延迟一段时间<code v-pre>watchOptions.aggregateTimeout</code>后，重新构建一次，并释放已经累积的缓存文件。</p>
<p>若是某些系统，监听大量文件会导致大量的 CPU 或内存占用。我们可以使用<code v-pre>watchOptions.ignored</code>忽略不必要的文件。</p>
...
<p>什么是文件指纹？即“打包后输出文件的后缀名”。<code v-pre>例如，&lt;script src=&quot;app703a459f67efec54a745.js&quot;&gt;&lt;/script&gt;里面的703a459f67efec54a745</code></p>
