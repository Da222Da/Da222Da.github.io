<template><h1 id="eslint-调查报告" tabindex="-1"><a class="header-anchor" href="#eslint-调查报告" aria-hidden="true">#</a> ESLint 调查报告</h1>
<div class="custom-container tip"><p class="custom-container-title">ESlint 一款插件化的 JavaScript 代码检查工具</p>
<nav class="table-of-contents"><ul><li><RouterLink to="#整体思维模式认识-eslint">#整体思维模式认识 ESLint</RouterLink><ul><li><RouterLink to="#_1-eslint-能给我们的-javascript-代码带来什么好处">1.ESLint 能给我们的 JavaScript 代码带来什么好处？</RouterLink></li><li><RouterLink to="#_2-eslint-快速上手">2.ESlint 快速上手</RouterLink></li></ul></li><li><RouterLink to="#专精思维模式练习-eslint">#专精思维模式练习 ESLint</RouterLink><ul><li><RouterLink to="#_1-已经使用了-eslint-的情况下-我们应不应该使用-prettier-呢">1.已经使用了 ESLint 的情况下，我们应不应该使用 Prettier 呢？</RouterLink></li></ul></li></ul></nav>
<p><a href="https://eslint.bootcss.com/" target="_blank" rel="noopener noreferrer">ESlint 官网<OutboundLink/></a></p>
</div>
<h2 id="整体思维模式认识-eslint" tabindex="-1"><a class="header-anchor" href="#整体思维模式认识-eslint" aria-hidden="true">#</a> #整体思维模式认识 ESLint</h2>
<h3 id="_1-eslint-能给我们的-javascript-代码带来什么好处" tabindex="-1"><a class="header-anchor" href="#_1-eslint-能给我们的-javascript-代码带来什么好处" aria-hidden="true">#</a> 1.ESLint 能给我们的 JavaScript 代码带来什么好处？</h3>
<ul>
<li>对于个人而言：代码检查可以减少 JS 代码 bug，保证代码质量。</li>
<li>对于团队而言：代码检查可以统一 JS 代码风格，提升多人协同开发的工作效能。</li>
</ul>
<h3 id="_2-eslint-快速上手" tabindex="-1"><a class="header-anchor" href="#_2-eslint-快速上手" aria-hidden="true">#</a> 2.ESlint 快速上手</h3>
<p>首先，我们得初始化源文件 package.json<code>npm init -y</code>，然后安装 ESLint 包<code>npm i eslint -D</code>。</p>
<p>之后，我们便可以使用 ESLint 提供的指令<code>./node_modules/.bin/eslint --init</code>，初始化配置文件<code>.eslintrc.js</code>。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// .eslint.js 配置文件详情</span>
...
<p>但是，每一次都需要我们手动去运行 ESlint，才能检查我们的代码，未免太麻烦了。</p>
<p>如何在 VSCode 编辑器中自动运行 ESLint 呢？需要我们先安装 VSCode ESlint 插件，并配置 VSCode settings.json 文件：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// settings.json</span>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><h2 id="专精思维模式练习-eslint" tabindex="-1"><a class="header-anchor" href="#专精思维模式练习-eslint" aria-hidden="true">#</a> #专精思维模式练习 ESLint</h2>
<h3 id="_1-已经使用了-eslint-的情况下-我们应不应该使用-prettier-呢" tabindex="-1"><a class="header-anchor" href="#_1-已经使用了-eslint-的情况下-我们应不应该使用-prettier-呢" aria-hidden="true">#</a> 1.已经使用了 ESLint 的情况下，我们应不应该使用 Prettier 呢？</h3>
<ul>
<li>eslint 注重代码质量
<ul>
<li>例如，let a = 1; 当你只声明，但未使用变量 a 时，从而导致代码后期可能报错。ESLint 就会警告了。</li>
</ul>
</li>
<li>prettier 注重代码风格 <code>prettier关注的是如何让代码更好看</code>
<ul>
<li>例如，一行多少个字符啊！加不加分号啊！诸如此类的问题？</li>
<li>pretter 还有强大的--fix 能力，帮助我们自动格式化。</li>
</ul>
</li>
</ul>
<p>其实，eslint 也能设置代码风格相关的规则，也有--fix 自动格式化能力，只是没有 prettier 那么强大。</p>
<p>如果你十分注重代码风格的话？可以使用 ESLint prettier 相关插件，帮我们做以下两个事</p>
<ul>
<li>第一件事：禁用掉所有与 Prettier 发生冲突的 ESLint 代码格式化规则。</li>
<li>第二件事：将 Prettier 的所有规则导入 ESLint 当中。</li>
</ul>
<p>如此，我们能使用 ESLint 强大的代码质量检测能力，又能享用 prettier 强大的代码风格格式化功能。</p>
<p>不过，配置 prettier 之后，会让 eslint 配置复杂度会变大，如何取舍？全凭个人需求。</p>
</template>
